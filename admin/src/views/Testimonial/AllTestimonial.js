...
function AllTestimonial() {
    ...
    const handleFetchBanner = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://www.api.upfda.in/api/v1/get-all-testimonial');
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        ...
        try {
            ...
            const res = await axios.put(`https://www.api.upfda.in/api/v1/update-testimonial-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        setLoading(true);
        try {
            await axios.delete(`https://www.api.upfda.in/api/v1/delete-testimonial/${id}`);
