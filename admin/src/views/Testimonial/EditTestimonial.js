...
function EditTestimonial() {
    ...
    const handleFetchTestimonial = async () => {
        try {
            const { data } = await axios.get(`https://www.api.upfda.in/api/v1/get-single-testimonial/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.put(`https://www.api.upfda.in/api/v1/update-testimonial/${id}`, payload, {
