    ...
    <>
      <div className="min-h-screen bg-gray-50 flex">
        ...
        >
          ...
          {/* Drawer */}
          <aside
            className={`relative w-72 max-w-full bg-white h-full shadow-xl transform transition-transform duration-300 ${
          ...
          >
            ...
            <div className="border-t mt-4 pt-4 px-4 space-y-2">
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-100 text-sm">
                <User className="w-5 h-5" /> Profile
              </button>
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-100 text-red-600 text-sm">
        ...
        <aside className="hidden md:block w-64 bg-white shadow-lg">
          ...
          <div className="border-t mt-6 pt-4 px-4 space-y-2">
            <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-100">
              <User className="w-5 h-5" /> Profile
            </button>
            <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-100 text-red-600">
              <LogOut className="w-5 h-5" /> Logout
            </button>
          </div>
        </aside>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="bg-linear-to-r from-indigo-900 to-blue-900 text-white px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
            <div className="flex flex-col gap-3">
              ...
              {/* Info text */}
              <p className="text-xs sm:text-sm max-w-4xl">
            ...
            <div className="flex gap-4 sm:gap-8 border-b mb-6 sm:mb-8 overflow-x-auto">
              {["home", "meetings", "slots"].map((tab) => (
                <button
                  ...
                  className={`pb-3 sm:pb-4 px-1 sm:px-2 font-medium capitalize transition border-b-4 whitespace-nowrap ${
                    activeTab === tab
